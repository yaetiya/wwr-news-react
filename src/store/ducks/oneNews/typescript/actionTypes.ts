...
export interface SetCommentOneNewsDataActionInterface extends Action<OneNewsActionsType> {
...
export interface SendCommentDataActionInterface extends Action<OneNewsActionsType> {
  type: OneNewsActionsType.SEND_COMMENT;
  payload: TPreComment;
}export interface SetErrorMessageDataActionInterface extends Action<OneNewsActionsType> {
